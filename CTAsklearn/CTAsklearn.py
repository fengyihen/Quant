...
class CTADaySklearn(FutureDay.Future):
    def tprday(self, hsma, fee):
        pass


class CTAsklearn(FutureMinute.Future):
    def logistic_dayin(self, testlen, ntrain, llen, slen, tr):

        hsmadata = self.hsmadata(llen, slen)

        filename = 'Test\\CTAsklearn\\testresult\\logistic_dayin_llen{}_slen{}_{}.h5'.format(
            llen, slen, self.label)
        ...
        for i in range(ntrain, ntest):
            ...
            X_train = traindata[[
                'roc', 'dayr', 'dayh', 'dayl', 'dayhl', 'smar', 'VAR',
                'timepos'
            ]]
    ...
    def tree_dayin(self, testlen, ntrain, llen, slen, tr):
        ...
        filename = 'Test\\CTAsklearn\\testresult\\tree_dayin_llen{}_slen{}_{}.h5'.format(
            llen, slen, self.label)
